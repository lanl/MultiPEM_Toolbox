...
ms_paths[[1]][[1]] = c("HR-51","HTA-11","HTA-5")
psy[[1]][[1]] = c(2,5,6)
ms_paths[[2]][[1]] = c("HRR-3","HR-54","HR-58","SAY-2")
psy[[2]][[1]] = c(7,9,10,14)
ms_paths[[3]][[1]] = c("HTP-14")
psy[[3]][[1]] = 17

ms_paths[[1]][[2]] = c("HR-55","HR-42")
psy[[1]][[2]] = c(2,5)
ms_paths[[2]][[2]] = c("HRR-11","HR-58")
psy[[2]][[2]] = c(17,19)
ms_paths[[3]][[2]] = c("HTP-1","HTP-9","HTP-14","HTP-6")
psy[[3]][[2]] = c(7,9,10,14)
