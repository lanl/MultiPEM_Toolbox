...
ms_sources_1[[1]] = c("HRI-1")
pch_1[[1]] = 2
ms_sources_2[[1]] = c("HRR-5","FSS-2","HRIII-3","SAY-3")
pch_2[[1]] = c(7,9,10,14)
ms_sources_3[[1]] = c("HTP-5","HTP-1")
pch_3[[1]] = c(15,17)

ms_sources_1[[2]] = c("HRI-1")
pch_1[[2]] = 2
ms_sources_2[[2]] = c("HRR-5","SAY-3","SAY-1")
pch_2[[2]] = c(7,9,10)
ms_sources_3[[2]] = c("HTP-4","HTP-1","HTP-8")
pch_3[[2]] = c(15,17,19)
