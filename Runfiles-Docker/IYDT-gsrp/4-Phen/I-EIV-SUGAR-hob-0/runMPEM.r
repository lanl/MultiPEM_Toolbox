...
opt_files_in = c("Opt/opt_1_0.RData",
                 "Opt/opt_2_0.RData",
                 "Opt/opt_3_eiv_0.RData",
                 "Opt/opt_4_eiv_0.RData")
...
if( iBayes ){
  ...
  if( iBetaPrior ){
    ...
    prior_files_beta = c(paste(app_dir,'/lp_beta_s.r',sep=""),
                         paste(app_dir,'/lp_beta_o.r',sep=""))
    if( igrad ){
      gr_prior_files_beta = c(paste(app_dir,'/glp_beta_s.r',sep=""),
                              paste(app_dir,'/glp_beta_o.r',sep=""))
