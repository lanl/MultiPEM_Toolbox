...
calc_mle_cal = function(p_cal,gdir,adir,f,nst=10,ncor=1,igrad=TRUE,
                        bfgs=TRUE,igrck=TRUE,g=NULL,iresp=NULL,
                        fp_fm=NULL,fopt_in=NULL,Xst=NULL,fopt_out=NULL,
                        phen=NULL,pl="multicore")
{
  #
  # FUNCTION INPUTS
  #
  ...
  if( is.null(Xst) ){
    ...
    for( ii in 1:nst ){
      ...
      if( exists("eiv",where=p_cal,inherits=FALSE) && p_cal$eiv ){
        xst[1:p_cal$nsource] = p_cal$eiv_w
      }
