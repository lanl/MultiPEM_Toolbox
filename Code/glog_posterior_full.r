...
# log-posterior of the calibration parameters, including (optionally)  #
...
glpost_full = function(x, pc=p_cal)
{
  glpo = pc$gll_full(x, pc)
  c(glpo, numeric(pc$p_fgsn+pc$p_A))+pc$glprior(x, pc)
}
